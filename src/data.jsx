const allPortfolio = [
  {
    ...
    languages: {
      ...
      en: {
        description: 'This is the Capstone Project for the Web Application Development Program. The objective of this project was to use the skills learned through the program. As a final step to complete the full program of EPFL Extension School. After a project defense in front of a board of examiners, my project has been validated and congratulated.',
    ...
    languages: {
      ...
      en: {
        description: 'This is the Dynamic Web Applications course project. The fourth course project of the EPFL Extension School program.',
        firstTitleModal: 'Project overview',
    ...
    languages: {
      ...
      en: {
        description: 'The website is static HTML, CSS, and images, my job was to make these static web pages work dynamically with different JavaScript techniques.',
        formation: 'School',
        firstTitleModal: 'Project overview',
    ...
    languages: {
      ...
      en: {
        description: "This is the Introduction to Ruby on Rails course project. The third course project of the EPFL Extension School program.",
        formation: 'School',
        firstTitleModal: 'Project overview',
